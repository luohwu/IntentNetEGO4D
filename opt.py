...
if args.euler:
    ...
    args.frames_path = '/data/luohwu/dataset/EGO4D/rgb_frames_resized'
    args.exp_path = '/data/luohwu/experiments'
else:
    # running on local computer
    args.data_path = '/media/luohwu/T7/dataset/EGO4D/'
    args.annos_path = '/home/luohwu/ait-data/dataset/EGO4D/nao_annotations'
    args.frames_path = '/media/luohwu/T7/dataset/EGO4D/rgb_frames_resized'
    args.exp_path = '/media/luohwu/T7/experiments'
